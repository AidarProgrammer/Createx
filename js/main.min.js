...
"use strict";var $jq=jQuery.noConflict(),mobileNavButton=($jq(function(){$jq(".sign-in__cross").on("click",function(){$(".sign-in").addClass("sign-in--close")}),$jq(".header__login-link--login").on("click",function(){$jq(".sign-in").removeClass("sign-in--close")}),$jq(".sign-up__cross").on("click",function(){$(".sign-up").addClass("sign-up--close")}),$jq(".header__login-link--register").on("click",function(){$jq(".sign-up").removeClass("sign-up--close")}),$jq(".sign-in__no-account").on("click",function(){$(".sign-up").removeClass("sign-up--close"),$(".sign-in").addClass("sign-in--close")}),$jq(".sign-up__no-account").on("click",function(){$(".sign-in").removeClass("sign-in--close"),$(".sign-up").addClass("sign-up--close")}),$jq(".sign-in__forget-password").on("click",function(){$jq(".sign-up").removeClass("sign-up--close"),$(".sign-in").addClass("sign-in--close")});mixitup(".benefits__inner",{load:{filter:".experienced"}});$jq(".our-team__cards").slick({slidesToShow:4,slidesToScroll:1,prevArrow:'<button class="slider-left"</button>',nextArrow:'<button class="article-slider__arrow slider-right--active" type="button"></button>',responsive:[{breakpoint:900,settings:{slidesToShow:3,slidesToScroll:1}},{breakpoint:601,settings:{slidesToShow:2,slidesToScroll:1}},{breakpoint:501,settings:{slidesToShow:1,slidesToScroll:1}}]})}),jQuery(document).ready(function(){$(".footer__copy-top").on("click",function(n){n.preventDefault(),$("html, body").animate({scrollTop:0},"300")})}),document.querySelector(".mobile-nav-button")),mobileNavIcon=document.querySelector(".mobile-nav-button__icon"),mobileNav=document.querySelector(".mobile-nav");mobileNavButton.addEventListener("click",function(){mobileNavIcon.classList.toggle("active"),mobileNav.classList.toggle("active"),document.body.classList.toggle("no-scroll")});
